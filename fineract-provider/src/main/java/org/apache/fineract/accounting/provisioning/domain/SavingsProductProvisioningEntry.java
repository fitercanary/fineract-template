...
@Entity
@Table(name = "m_savings_product_provisioning_entry")
public class SavingsProductProvisioningEntry extends AbstractPersistableCustom<Long> {
	...
	public boolean equals(Object obj) {
		...
		SavingsProductProvisioningEntry entry = (SavingsProductProvisioningEntry) obj;
		return entry.savingsProduct.getId().equals(this.savingsProduct.getId())
