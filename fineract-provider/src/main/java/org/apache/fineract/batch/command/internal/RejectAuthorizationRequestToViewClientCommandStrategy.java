 ...
 * reject authorization request to view a client. It passes the contents of the body from the
 * BatchRequest to
 ...
 */
@Component
public class RejectAuthorizationRequestToViewClientCommandStrategy implements CommandStrategy{

    private final UsersApiResource usersApiResource;
    
    @Autowired
    public RejectAuthorizationRequestToViewClientCommandStrategy(final UsersApiResource usersApiResource) {
    ...
    public BatchResponse execute(BatchRequest batchRequest, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        try {
            ...
            responseBody = usersApiResource.authorize(authorizationRequestId, "reject", batchRequest.getBody());
