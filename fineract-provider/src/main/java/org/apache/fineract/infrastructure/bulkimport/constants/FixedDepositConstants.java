...
public class FixedDepositConstants {
    ...
    public static final int NOMINAL_ANNUAL_INTEREST_RATE_COL = 7;
    public static final int INTEREST_COMPOUNDING_PERIOD_COL = 8;
    public static final int INTEREST_POSTING_PERIOD_COL = 9;
    public static final int INTEREST_CALCULATION_COL = 10;
    public static final int INTEREST_CALCULATION_DAYS_IN_YEAR_COL = 11;
    public static final int LOCKIN_PERIOD_COL = 12;
    public static final int LOCKIN_PERIOD_FREQUENCY_COL = 13;
    public static final int DEPOSIT_AMOUNT_COL = 14;
    public static final int DEPOSIT_PERIOD_COL = 15;
    public static final int DEPOSIT_PERIOD_FREQUENCY_COL = 16;
    public static final int EXTERNAL_ID_COL = 17;
