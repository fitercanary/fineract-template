...
public class LoanWorkbookPopulator extends AbstractWorkbookPopulator {
	...
	private TrancheSheetPopulator trancheSheetPopulator;
	...
	public void populate(Workbook workbook, String dateFormat) {
		...
		trancheSheetPopulator.populate(workbook, dateFormat);
	...
	private void setLayout(Sheet worksheet) {
		...
		worksheet.setColumnWidth(LoanConstants.IS_TRANCHE_LOAN_COL, TemplatePopulateImportConstants.MEDIUM_COL_SIZE);
		...
		writeString(LoanConstants.IS_TRANCHE_LOAN_COL, rowHeader, "Is Tranche");
