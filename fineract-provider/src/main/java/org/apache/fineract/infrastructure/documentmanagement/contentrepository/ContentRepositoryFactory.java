...
public class ContentRepositoryFactory {
    ...
    public ContentRepositoryFactory(final ApplicationContext applicationContext,
            ...
            final FileSystemContentPathSanitizer contentPathSanitizer) {
        this.applicationContext = applicationContext;
        this.externalServicesReadPlatformService = externalServicesReadPlatformService;
        this.contentPathSanitizer = contentPathSanitizer;
    }
    ...
    public ContentRepository getRepository(final StorageType documentStoreType) {
        if (documentStoreType == StorageType.FILE_SYSTEM) { return new FileSystemContentRepository(contentPathSanitizer); }
