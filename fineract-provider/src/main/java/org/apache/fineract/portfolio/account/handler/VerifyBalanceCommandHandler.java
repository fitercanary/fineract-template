...
@Service
@CommandType(entity = "BALANCE", action = "VERIFY")
public class VerifyBalanceCommandHandler implements NewCommandSourceHandler {

    private final BalanceVerificationServiceFactory balanceVerificationServiceFactory;

    @Autowired
    public VerifyBalanceCommandHandler(BalanceVerificationServiceFactory balanceVerificationServiceFactory) {
        this.balanceVerificationServiceFactory = balanceVerificationServiceFactory;
    }

    @Override
    public CommandProcessingResult processCommand(JsonCommand command) {
        return this.balanceVerificationServiceFactory.verifyBalance(command);
    }
}
