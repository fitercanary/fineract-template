...
package org.apache.fineract.portfolio.account.runner;
...
public class BalanceVerificationRunner implements Runnable {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(BalanceVerificationRunner.class);

    public BalanceVerificationRunner(LocalDate verificationDate,
    ...
    public void run() {
        ...
        this.balanceVerificationService.verifyBalancesAsAt(verificationDate);
    }

    public void start() {
        LOGGER.info("Starting BalanceVerificationRunner...");
