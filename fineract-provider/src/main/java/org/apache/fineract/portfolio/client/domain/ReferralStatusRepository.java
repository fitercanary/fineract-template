...
public interface ReferralStatusRepository
		extends JpaRepository<ReferralStatus, Long>, JpaSpecificationExecutor<ReferralStatus> {

	ReferralStatus findReferralStatusByClientAndPhoneNo(Client client, String phoneNo);
