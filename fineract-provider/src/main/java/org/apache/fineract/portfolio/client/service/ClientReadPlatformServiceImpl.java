...
public class ClientReadPlatformServiceImpl implements ClientReadPlatformService {
    ...
    private static final class ClientMembersOfGroupMapper implements RowMapper<ClientData> {
        ...
        public ClientMembersOfGroupMapper() {
            ...
            sqlBuilder.append("c.mothers_maiden_name as mothersMaidenName, ");
            ...
            sqlBuilder.append("c.client_level_cv_id as clientLevelId, ");
            sqlBuilder.append("cvclientlevel.code_value as clientLevelValue, ");
        ...
        public ClientData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final String mothersMaidenName = rs.getString("mothersMaidenName");
    ...
    private static final class ClientMapper implements RowMapper<ClientData> {
        ...
        public ClientMapper() {
            ...
            builder.append("c.mothers_maiden_name as mothersMaidenName,");
            ...
            builder.append("c.client_level_cv_id as clientLevelId, ");
            builder.append("cvclientlevel.code_value as clientLevelValue, ");
            ...
            builder.append("left join m_code_value cvclientlevel on cvclientlevel.id = c.client_level_cv_id ");
    ...
    public String getReferralId(Long clientId) {
        Client client = this.clientRepositoryWrapper.findOneWithNotFoundDetection(clientId);
        if (StringUtils.isNotBlank(client.getReferralId())) { return client.getReferralId(); }
        while (true) {
    ...
    public String getDynamicLink(Long clientId) {
        Client client = this.clientRepositoryWrapper.findOneWithNotFoundDetection(clientId);
        if (StringUtils.isNotBlank(client.getReferralId())) { return client.getReferralDynamicLink(); }
        return "";
    }
