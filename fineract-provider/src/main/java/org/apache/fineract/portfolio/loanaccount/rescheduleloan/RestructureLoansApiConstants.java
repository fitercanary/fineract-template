...
public class RestructureLoansApiConstants {

    public final static String ENTITY_NAME = "RESTRUCTURELOAN";
    ...
    public static final String resheduleWithInterestRecalculationNotSupportedErrorCode = "loan.resetructure.interestrecalculation.error.code";
    ...
    public static String modifyLoanTermParamName="modifyLoanTerm";
    public static String paidInstallmentsParamName="paidInstallments";
    public static String pendingInstallmentsParamName="pendingInstallments";
