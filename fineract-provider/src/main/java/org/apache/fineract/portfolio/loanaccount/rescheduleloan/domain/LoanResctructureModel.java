...
public final class LoanResctructureModel {
    ...
    private LoanResctructureModel(final Collection<LoanRescheduleModelRepaymentPeriod> periods,
    ...
    public static LoanResctructureModel instance(final Collection<LoanRescheduleModelRepaymentPeriod> periods,
                                                 final Collection<LoanRepaymentScheduleHistory> oldPeriods, final ApplicationCurrency applicationCurrency,
                                                 final int loanTermInDays, final Money principalDisbursed, final BigDecimal totalPrincipalExpected,
                                                 final BigDecimal totalPrincipalPaid, final BigDecimal totalInterestCharged, final BigDecimal totalFeeChargesCharged,
                                                 final BigDecimal totalPenaltyChargesCharged, final BigDecimal totalRepaymentExpected, final BigDecimal totalOutstanding) {

        return new LoanResctructureModel(periods, oldPeriods, applicationCurrency, loanTermInDays, principalDisbursed,
    ...
    public static LoanResctructureModel createWithSchedulehistory(LoanResctructureModel loanRescheduleModel,
                                                                  final Collection<LoanRepaymentScheduleHistory> oldPeriods) {

        return new LoanResctructureModel(loanRescheduleModel.periods, oldPeriods, loanRescheduleModel.applicationCurrency,
