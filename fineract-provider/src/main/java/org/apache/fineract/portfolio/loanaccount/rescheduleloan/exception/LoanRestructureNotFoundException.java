 ...
 **/
public class LoanRestructureNotFoundException extends AbstractPlatformResourceNotFoundException {
	 ...
	 *
	 **/
	public LoanRestructureNotFoundException(final Long requestId) {
	...
	public LoanRestructureNotFoundException(final String loanId) {
		super("error.msg.loan.reschedule.request.exists",
				"Loan restructure request for loan Id: " + loanId + " Already exists and pending approval", loanId);
	}
