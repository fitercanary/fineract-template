...
public class ConfirmPartLiquidationRequestCommandHandler implements NewCommandSourceHandler {
	...
	@Autowired
	public ConfirmPartLiquidationRequestCommandHandler(
			LoanPartLiquidationPreviewPlatformService loanPartLiquidationPreviewPlatformService) {
	...
	public CommandProcessingResult processCommand(JsonCommand jsonCommand) {
		return this.loanPartLiquidationPreviewPlatformService.confirmPartLiquidation(jsonCommand);
	}
}
