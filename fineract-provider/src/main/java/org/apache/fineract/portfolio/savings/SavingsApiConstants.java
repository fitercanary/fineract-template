...
public class    SavingsApiConstants {
	...
	public static final String COMMAND_ADJUST_TRANSACTION_REQUEST = "modifyTransactionRequest";
	...
	public static final String postingDateName = "postingDate";
    public static final String officeIdParamName = "officeId";
    public static final String creditsParamName = "credits";
