...
@Service
@CommandType(entity = "TRANSACTIONCLASSIFICATION", action = "DELETE")
public class DeleteTransactionClassificationCommandHandler implements NewCommandSourceHandler {

    private final TransactionClassificationWritePlatformService transactionClassificationWritePlatformService;

    @Autowired
    public DeleteTransactionClassificationCommandHandler(
    ...
    public CommandProcessingResult processCommand(JsonCommand command) {
        return transactionClassificationWritePlatformService.deleteTransactionClassification(command);
    }
}
