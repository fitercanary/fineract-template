...
import org.apache.fineract.portfolio.validation.limit.serialization.ValidationLimitCommandFromApiJsonDeserializer;
...
public class ValidationLimitWritePlatformServiceJpaRepositoryImpl implements ValidationLimitWritePlatformService {
    ...
    private final static Logger logger = LoggerFactory.getLogger(ValidationLimitWritePlatformServiceJpaRepositoryImpl.class);
